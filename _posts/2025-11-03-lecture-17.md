...
It is used for LSUN scene modeling. 
Architecture: it uses 4 fractoinally strided convolutions and converts it to a 64 x64 image. No pooling layers or FCNs are used
<figure>
